<article class="card mb-4 rounded">
    ...
    @empty(!$image)
        <div class="col-12 col-auto"> <!-- col-md-5 -->
            <a href="{{ App\Link::route('sources', ['id' => md5($key)]) }}" class="d-block">
                {{--
                <img
                    src="{{ $image }}"
                ...
                <div class="row">
                    <div class="col d-flex flex-column">
                        <h2 class="text-dark font-weight-bolder">
                            <a href="{{  App\Link::route('sources', ['id' => md5($key)]) }}">{{$title}}</a>
                        </h2>
    ...
    <a href="{{  App\Link::route('sources', ['id' => md5($key)]) }}" class="stretched-link"></a>
</article>
