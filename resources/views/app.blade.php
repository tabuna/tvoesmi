...
<nav class="navbar fixed-bottom mobile-menu p-0 d-block d-xxl-none overflow-hidden min-vw-100 vw-100 border-end-0" style="background: #36393f!important;">
   <div class="container">
    <div class="row d-flex align-items-center g-0 vw-100 mb-2 px-4">
        <div class="col text-center position-relative">
            <a href="{{ url('/') }}" class="pt-2 pb-2 d-block text-white">
        ...
        <div class="col text-center">
            <a href="{{ url('/list') }}" class="pt-2 pb-2 d-block text-white">
